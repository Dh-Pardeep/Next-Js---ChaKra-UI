    ...
    return (
        <>
            <Container maxW={"1140px"} mx={"auto"} >
                <MyNav />
                <Box mt={'92px'}>
                    <Heading as={'h1'} fontSize={'48px'} textAlign={'center'} fontFamily={'fontmerriweather'} fontWeight={'900'} color={'#000638'} lineHeight={'100%'} mb={'10px'}>The Food Ninja Blog</Heading>
