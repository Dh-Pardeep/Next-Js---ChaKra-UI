    ...
    return (
        <>
            <Container maxW={"1140px"} mx={"auto"} >
                <MyNav />
                <Box mt={'92px'}>
                    <Heading as={'h1'} fontSize={['32px', '40px', '48px']} textAlign={'center'} fontFamily={'fontmerriweather'} fontWeight={'900'} color={'#000638'} lineHeight={'100%'} mb={'10px'}>The Food Ninja Blog</Heading>
                    <Text as={'p'} textAlign={'center'} color={'#605C59'} lineHeight={'100%'} fontSize={'20px'} mb={'55px'}>A blog about food, experiences, and recipes. </Text>
                    <Stack mx={'auto'} pos={'relative'} maxW={'430px'} w={'100%'} border={'1px solid #DDD'} borderRadius={'5px'}>
                        ...
                        <Box pos={'absolute'} top={'50%'} zIndex={'10'} cursor={'pointer'} right={'24px'} transform={'translateY(-50%)'}><SearchIcon /></Box>
                    </Stack>
                </Box>
            </Container >
        </>
